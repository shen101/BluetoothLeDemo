...
public class HelmetScanBluetoothDevicesActivity extends Activity implements OnClickListener {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(intent.getAction())) {
				...
				if (!temp_name.contains(mDevice.getName())) {
					...
					mScanAdapter = new HelmetBluetoothScanAdapter(mContext, devices);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bluetooth_scan_layout);
		mContext = HelmetScanBluetoothDevicesActivity.this;
	...
	private void initViews() {
		...
		lv_view.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				// TODO Auto-generated method stub
				try {
					HelmetToolUtils.createBond(devices.get(position).getClass(), devices.get(position));
				} catch (Exception e) {
